  ...
  <div id="container">
    ...
    <div class="search-and-sort">
      <div class="search-container">
        <input type="text" v-model="searchQuery" @input="searchFriends" placeholder="Buscar amigos por nombre"
          class="search-input">
    ...
    <div class="scrollable-content">
      <transition-group name="fade">
        ...
        <div v-else class="amigos-lista">
          <div v-for="amigo in filteredAmigos" :key="amigo.id" @click="startChatWith(amigo.id, amigo.name)"
            class="amigo">
...
.search-input:focus {
  border-color: #075e54;
  /* Color verde de WhatsApp al enfocar */
}
