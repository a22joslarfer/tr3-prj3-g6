<template>
    <div id="container">
        ...
        <div class="chatbox">
            <div class="messages">
                <div :class="['message', { 'sent': message.sent, 'received': !message.sent }]" v-for="message in messages" :key="message.id">
                    <p>{{ message.text }}</p>
    ...
    methods: {
        ...
        async fetch() {
            try {
                ...
                this.profileImageUrl = this.getProfilePhotoUrl(profilePhotoData.path);
            } catch (error) {
        ...
        sendPrivateMessage() {
            if (this.newMessage.trim() !== '') {
                ...
                this.messages.push({ text: this.newMessage, from: this.userId, fromProfilePhoto: this.profileImageUrl, sent: true });
                this.newMessage = '';
            }
        },
        checkIfAuth() {
